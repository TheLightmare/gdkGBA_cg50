...
// Sound is currently disabled (sound_clock / sound_buffer_wrap are not
// called), so snd_buffer is unused. Keep it tiny to reclaim BSS - the CG50
// add-in memory budget is already very tight.
#define BUFF_SAMPLES      64
