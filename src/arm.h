...
// See note in io.h: lo/hi/b0..b3 here are named for their *little-endian*
// position within w (b0 = low byte, h.lo = low halfword), and the field
// order has to be reversed on big-endian hosts to keep that meaning.
