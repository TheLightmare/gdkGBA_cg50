...
// b0..b3 are in *memory order from low address to high*. On a little-endian
// host b0 == bits 7..0 of w; on a big-endian host (SH4 on the CG50) b0 ==
// bits 31..24. The original gdkGBA code was written for LE hosts and uses
// b0 to mean "low byte of w" everywhere. Reorder the field list so that b0
// keeps that meaning on big-endian as well.
